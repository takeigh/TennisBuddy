 ...
 * Use the {@link CreateMatch#newInstance} factory method to
...
public class CreateMatch extends Fragment {
    ...
    public static CreateMatch newInstance(String param1, String param2) {
        CreateMatch fragment = new CreateMatch();
